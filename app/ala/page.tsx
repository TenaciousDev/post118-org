...
const { title, body, comingSoon } = JSON.parse(
  fs.readFileSync(path.join(process.cwd(), "content/pages/ala.json"), "utf-8")
) as { title: string; body: string; comingSoon: boolean };
      ...
      <section className="bg-legion-navy px-6 pt-10 pb-12 relative">
        <div className="max-w-4xl mx-auto">
          <nav className="text-white/40 text-sm mb-4">
            ...
            <span className="text-white/70">American Legion Auxiliary</span>
          </nav>
